...
const PageSidebar = ({
  ...
  return (
    <div id="docs-sidebar" className="fixed h-full w-56 scrollbar-y overflow-y-auto bg-white border-r border-gray-200 pt-4 pb-10">
      <nav className='flex flex-col items-center w-60'>
